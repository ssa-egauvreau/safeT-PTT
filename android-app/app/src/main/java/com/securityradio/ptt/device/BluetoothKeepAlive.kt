...
class BluetoothKeepAlive {
    ...
    private companion object {
        ...
        // 20 ms of inaudible low-level dither (±4 LSB ≈ -78 dBFS). Non-zero so the
        // A2DP stack never sees digital silence and suspends; far below audible.
        val FILL = ByteArray(320).also { buf ->
            var seed = 0x9E3779B9.toInt()
            var i = 0
            while (i + 1 < buf.size) {
                seed = seed * 1103515245 + 12345
                val v = ((seed ushr 16) % 9) - 4 // [-4, 4]
